...
// FIX 1: Restructured saveState — guard moved before the Firestore call,
// chained .doc().set() written correctly, and publishState() placed inside the function.
...
// FIX 2: render() body is now properly closed with its own closing brace.
// renderShareStatus and all other render* helpers are correctly defined outside render().
function render() {
...
// FIX 3: Removed the orphaned auth.signOut() + sessionStorage.removeItem() block
// that was floating outside any function. The logoutButton listener below handles this correctly.
